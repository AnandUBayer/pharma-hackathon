...
const InsightsView: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      {/* Header */}
      <div>
        <h2 className="lmnt-theme-on-surface text-2xl font-bold">Performance Insights</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="lmnt-theme-background-bg rounded-xl p-4 shadow-md border lmnt-theme-divider-primary">
          ...
          <p className="lmnt-theme-on-surface text-sm">Call Compliance</p>
        </div>
      ...
      <div className="lmnt-theme-secondary-bg lmnt-theme-on-secondary rounded-xl p-5 shadow-md">
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex justify-between mb-1">
              <span className="text-sm">Call Compliance</span>
